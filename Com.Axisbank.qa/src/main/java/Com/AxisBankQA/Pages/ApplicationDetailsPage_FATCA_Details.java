...
public class ApplicationDetailsPage_FATCA_Details {
	@FindBy(id="DIY_PORTAL_APPLICANT_DETAILS_Ftca_Address_Type_For_Tax_Pu") private WebElement TaxPurposeAdd;
	...
	public ApplicationDetailsPage_FATCA_Details(WebDriver driver) {
