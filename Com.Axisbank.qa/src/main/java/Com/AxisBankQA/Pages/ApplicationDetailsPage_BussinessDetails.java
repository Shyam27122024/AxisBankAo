...
public class ApplicationDetailsPage_BussinessDetails {
	...
	@FindBy(id="DIY_PORTAL_APPLICANT_DETAILS_Annual_Income") private WebElement AnnualIncome;
	...
	//Initialization
	public ApplicationDetailsPage_BussinessDetails(WebDriver driver) {
